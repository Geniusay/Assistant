...
public class TokenUtilsTest {
    ...
    @Test
    public void testCreateTokenByMap(){
        String accessToken = tokenUtils.createToken(Map.of(
                "username", "Genius",
                "uid", "123456"
        ), "123456").getAccessToken();
        System.out.println(tokenUtils.parseTokenToObj(accessToken, "username", String.class));
    }
